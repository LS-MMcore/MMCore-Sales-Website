          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2 max-w-6xl mx-auto">
              {platformFeatures.map((feature, index) => (
                <Card
                  key={index}
                  className="h-full border-[#63b2dc]/30 hover:border-[#63b2dc]/50 transition-colors"
                >
                  <CardHeader>
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="mx-auto max-w-[700px] text-white/90 md:text-lg">
                {t("services.carrierNetwork.subtitle")}
              </p>
            </div>
            ...
            <Card className="max-w-6xl mx-auto bg-white/95 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-slate-800">
                  {t("services.carrierNetwork.section.title")}
                </CardTitle>
        ...
        <section className="w-full py-12 md:py-24" style={{ backgroundColor: "#63b2dc10" }}>
          <div className="container px-4 md:px-6">
            <div className="text-center space-y-6 max-w-2xl mx-auto">
              ...
              <p className="text-slate-700 md:text-lg">{t("services.ctaParagraph")}</p>
