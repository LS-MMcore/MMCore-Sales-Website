          ...
          <div className="space-y-8 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="#contact">
                <Button
                  size="lg"
                  className="bg-white text-[#63b2dc] hover:bg-gray-100 font-semibold px-8 py-4 text-lg group"
                >
                  {t("hero.getStarted")}
              ...
              <Link href="/api-docs">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-white text-white hover:bg-white hover:text-[#63b2dc] bg-transparent font-semibold px-8 py-4 text-lg"
                >
                  {t("hero.viewApiDocs")}
                </Button>
              </Link>
